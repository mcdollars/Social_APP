...
const routes = [
  ...
  { path: "/popular-experiences-map", component: ExperienceMapMostPopular, exact: true },
  { path: "/create-experiences-map", component: CreateExperienceMap, exact: true },
  { path: "/create-experiences-map/:id", component: CreateExperienceMap, exact: true },
  { path: "/create-experiences-activity", component: CreateExperienceActivity, exact: true },
  { path: "/close-create-experiences", component: CloseCreateExperience, exact: true },
